...
% obj_colormap: colormap to display the multi-class segmentation
load('lmo_example_data.mat', 'im1', 'im2', 'anno1', 'anno2');
load('lmo_pca_basis.mat', 'pca_basis'); 
load('obj_colormap.mat', 'obj_colormap'); 
...
% Evaluation
[acc, seg] = EvaluateLMOMatch(anno1, anno2, vx, vy);
seg = seg2color(seg, obj_colormap); 
acc.time = t_match;
